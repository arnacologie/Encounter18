...
public class MapFragmentHomepage extends Fragment implements OnMapReadyCallback{

    GoogleMap mGoogleMap;
    MapView mMapView;
    View mView;

    public MapFragmentHomepage(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fragment_map_homepage, container, false);
        return mView;
    }
